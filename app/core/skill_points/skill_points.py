...
def calc_skill_pts(rcds, total_count_map=tier_count['total'], total_count_map5=tier_count[5], total_count_map6=tier_count[6], total_count_map7=tier_count[7], total_count_map567=tier_count[5] + tier_count[6] + tier_count[7]):
    ...
    formula = {
        ...
        'coefficient': 0.91,
        'formula': [
            {'name': 'tpwr', 'key': 'count_p1000_tp', 'denominator': total_count_map, 'weight': 1.1, 'root': 3.5, 'text': 'tpwr count', 'description': '(tp wr count / total map count)'},
            {'name': 'prowr', 'key': 'count_p1000_pro', 'denominator': total_count_map, 'weight': 6, 'root': 2.4, 'text': 'prowr count', 'description': '(pro wr count / total map count)'},
            {'name': '900+', 'key': 'count_p900', 'denominator': total_count_map, 'weight': .14, 'root': 2, 'text': '900+ count', 'description': '(900+ count / total map count)'},
            {'name': '800+', 'key': 'count_p800', 'denominator': total_count_map, 'weight': .04, 'root': 2, 'text': '800+ count', 'description': '(800+ count / total map count)', 'newline': True},

            {'name': 'point', 'key': 'pts_avg', 'denominator': 1000, 'weight': .07, 'root': 1, 'text': '均分',  'description': '平均分/1000'},

            {'name': 'point3', 'key': 'pts_avg_t3', 'denominator': 1000, 'weight': .01, 'root': 1, 'text': 't3 avg',  'description': 't3平均分/1000'},
            {'name': 'point4', 'key': 'pts_avg_t4', 'denominator': 1000, 'weight': .02, 'root': 1, 'text': 't4 avg',  'description': 't4平均分/1000'},
            {'name': 'point5', 'key': 'pts_avg_t5', 'denominator': 1000, 'weight': .1, 'root': 1, 'text': 't5 avg',  'description': 't5平均分/1000'},
            {'name': 'point6', 'key': 'pts_avg_t6', 'denominator': 1000, 'weight': .12, 'root': 1, 'text': 't6 avg', 'description': 't6平均分/1000'},
            {'name': 'point7', 'key': 'pts_avg_t7', 'denominator': 1000, 'weight': .17, 'root': 1, 'text': 't7 avg', 'description': 't7平均分/1000', 'newline': True},

            {'name': 'count', 'key': 'count', 'denominator': total_count_map, 'weight': .01, 'root': 1, 'text': 'finished maps', 'description': 'finished maps count / total map count'},
            ...
            {'name': 'count5', 'key': 'count_t5', 'denominator': total_count_map5, 'weight': .05, 'root': 1.5, 'text': 'finished t5', 'description': '(t5完成地图数/t5总地图数)'},
            {'name': 'count6', 'key': 'count_t6', 'denominator': total_count_map6, 'weight': .15, 'root': 1.5, 'text': 'finished t6', 'description': '(t6完成地图数/t6总地图数)'},
            {'name': 'count7', 'key': 'count_t7', 'denominator': total_count_map7, 'weight': .24, 'root': 1.5, 'text': 'finished t7', 'description': '(t7完成地图数/t7总地图数)', 'newline': True},
